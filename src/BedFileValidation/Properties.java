...
/**
 * Properties file for Bed File Validation
...
public class Properties {
	...
	public static String bedFileDirectory = "No peppy file set!";
	...
	private static void setPropertyFromString(String line) {
		...
		//Files
		if (propertyName.equals("bedFileDirectory")) 
			bedFileDirectory = propertyValue.trim();
